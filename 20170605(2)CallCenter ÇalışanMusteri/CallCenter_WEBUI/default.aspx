<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="CallCenter_WEBUI._default" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDogumTarihi" PopupPosition="Right"></asp:CalendarExtender>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td>Unvan</td>
            <td>
                <asp:DropDownList ID="ddlUnvan" runat="server">
                </asp:DropDownList>
